...
أضيف download-engine وtransfer-store. تعليمات البناء وتشغيل الاختبارات الفعلية في [دليل الناقل](../crates/download-engine/README.md). تخزين SQLite وnative TLS يزيدان متطلبات البناء؛ نجح البناء على MSVC الموجود. لا تزال الأنظمة الأخرى غير متحققة.
