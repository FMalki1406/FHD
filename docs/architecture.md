...
## قرار تنفيذ داخلي 2026-09-21

transfer-store يستخدم SQLite DELETE journal وsynchronous=FULL لمالك واحد بدل WAL المقترح لتطبيق أوسع. السبب تقليل حالات ملفات journal الجانبية في هذه الوحدة؛ الانتقال إلى تعدد القراء/المهام يحتاج قياسًا وترحيلًا ومراجعة. النشر hard link داخل مجلد مهمة موثوق دون overwrite، وتبقى part. مزامنة دليل Windows وحماية الروابط السرية وسباقات المسار العدائية ليست محلولة؛ لا يطابق التنفيذ بعد عقد المتانة الإنتاجي الكامل. التفاصيل في [حالة التنفيذ](execution-status.md).
