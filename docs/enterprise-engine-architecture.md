...
| مستخدم آخر على نفس الجهاز | **مُخفَّف على Unix** (ملكية وصلاحيات وSO_PEERCRED). **غير مُخفَّف على Windows:** بلا DACL ولا تحقق مالك، انتحال اسم الأنبوب يسرّب ما يرسله العميل (ومنه رابط موقّع) لا مجرد تعطيل. رفض الوجهات المشتركة غير منفَّذ؛ المنفَّذ رفض الوجهة داخل شجرة المحرك وخارج جذر التنزيل وأسماء §16.4 |
