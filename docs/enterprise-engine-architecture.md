...
> **تفسير معتمد (2026-09-23) لبند المعالج:** «دون مرحلة التحقق» تعني **التحقق النهائي وحده** — قراءة الملف كاملًا وتجزئته قبل النشر. أما **تجزئة نقاط التفتيش (بصمة كل نطاق) فتُحسب ضمن تكلفة النقل**، لأنها لازمة أثناء التنزيل نفسه لضمان الاستئناف، وليست مرحلة لاحقة. لذلك يُقيَّم بند المعالج على **استهلاك طور النقل شاملًا تجزئة نقاط التفتيش**، و**لا يُحمَّل عليه التحقق النهائي**؛ فالرقمان يُعرضان منفصلين ولا يُجمعان في حكم واحد. والرقم الذي يستثني تجزئة نقاط التفتيش يبقى **للتشخيص فقط** لا للحكم. أرقام خط الأساس في [القياسات](engine-measurements.md).
