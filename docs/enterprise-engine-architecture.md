...
| مستخدم آخر على نفس الجهاز | **مُخفَّف:** IPC للمالك، part للمالك فقط، رفض الوجهات المشتركة، أسرار لكل مستخدم. **متبقٍ:** انتحال اسم الـpipe يسبب DoS لا اختراق |
| تطبيقات sandboxed بنفس الحساب (AppContainer، Low-IL، Flatpak) | ممنوعة من الـIPC بتصميم الصلاحيات؛ يُختبر |
